...
#define HT1621_CS_H() P2OUT |= BIT5
#define HT1621_CS_L() P2OUT &= ~BIT5
...
void HT1621_Display(unsigned char num1,unsigned char num2,unsigned char num3,unsigned char num4,unsigned char colon, unsigned char dot);

void HT1621_UpdateStatusDisplay(unsigned char frameReceivedCounter,char phaseSynchronized,char timeSynchronized,unsigned int listenCounterDown);
