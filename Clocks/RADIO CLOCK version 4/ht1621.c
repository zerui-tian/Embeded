...
void HT1621_Display(unsigned char num1,
                    ...
                    unsigned char dot){
    if(num1 < 10){
        Write1DataHT1621(HT1621_segtab[0],  ((LCD_RAM_Tab[num1]>>4)&0x0F)|(colon?0x08:0x00));
        Write1DataHT1621(HT1621_segtab[1],  (LCD_RAM_Tab[num1]>>0)&0x0F);
    }
    else{
        Write1DataHT1621(HT1621_segtab[0],  (colon?0x08:0x00));
        Write1DataHT1621(HT1621_segtab[1],  0);
    }
    if(num2 < 10){
        Write1DataHT1621(HT1621_segtab[2],  (LCD_RAM_Tab[num2]>>4)&0x0F);
        Write1DataHT1621(HT1621_segtab[3],  (LCD_RAM_Tab[num2]>>0)&0x0F);
    }
    else{
        Write1DataHT1621(HT1621_segtab[2],  0);
        Write1DataHT1621(HT1621_segtab[3],  0);
    }
    if(num3 < 10){
        Write1DataHT1621(HT1621_segtab[4],  ((LCD_RAM_Tab[num3]>>4)&0x0F)|(dot?0x08:0x00));
        Write1DataHT1621(HT1621_segtab[5],  (LCD_RAM_Tab[num3]>>0)&0x0F);
    }
    else{
        Write1DataHT1621(HT1621_segtab[4],  (dot?0x08:0x00));
        Write1DataHT1621(HT1621_segtab[5],  0);
    }
    if(num4 < 10){
        Write1DataHT1621(HT1621_segtab[6],  (LCD_RAM_Tab[num4]>>4)&0x0F);
        Write1DataHT1621(HT1621_segtab[7],  (LCD_RAM_Tab[num4]>>0)&0x0F);
    }
    else{

        Write1DataHT1621(HT1621_segtab[6],  0);
        Write1DataHT1621(HT1621_segtab[7],  0);
    }
}
...
void HT1621_UpdateStatusDisplay(
    ...
    if(listenCounterDown>0){
        if(phaseSynchronized){
            Write1DataHT1621(HT1621_segtab[0],  (LCD_RAM_Tab[18]>>4)&0x0F);
            Write1DataHT1621(HT1621_segtab[1],  (LCD_RAM_Tab[18]>>0)&0x0F);
            if(timeSynchronized){
                Write1DataHT1621(HT1621_segtab[2],  (LCD_RAM_Tab[18]>>4)&0x0F);
                Write1DataHT1621(HT1621_segtab[3],  (LCD_RAM_Tab[18]>>0)&0x0F);
                Write1DataHT1621(HT1621_segtab[4],  (LCD_RAM_Tab[18]>>4)&0x0F);
                Write1DataHT1621(HT1621_segtab[5],  (LCD_RAM_Tab[18]>>0)&0x0F);
                Write1DataHT1621(HT1621_segtab[6],  (LCD_RAM_Tab[18]>>4)&0x0F);
                Write1DataHT1621(HT1621_segtab[7],  (LCD_RAM_Tab[18]>>0)&0x0F);
            }
            else{
                if(frameReceivedCounter==2){
                    Write1DataHT1621(HT1621_segtab[2],  (LCD_RAM_Tab[18]>>4)&0x0F);
                    Write1DataHT1621(HT1621_segtab[3],  (LCD_RAM_Tab[18]>>0)&0x0F);
                    Write1DataHT1621(HT1621_segtab[4],  0);
                    Write1DataHT1621(HT1621_segtab[5],  0);
                    Write1DataHT1621(HT1621_segtab[6],  0);
                    Write1DataHT1621(HT1621_segtab[7],  0);
                }
        ...
        Write1DataHT1621(HT1621_segtab[0],  (LCD_RAM_Tab[15]>>4));
        Write1DataHT1621(HT1621_segtab[1],  (LCD_RAM_Tab[15]>>0));
        Write1DataHT1621(HT1621_segtab[2],  (LCD_RAM_Tab[10]>>4));
        Write1DataHT1621(HT1621_segtab[3],  (LCD_RAM_Tab[10]>>0));
        Write1DataHT1621(HT1621_segtab[4],  (LCD_RAM_Tab[22]>>4));
        Write1DataHT1621(HT1621_segtab[5],  (LCD_RAM_Tab[22]>>0));
        Write1DataHT1621(HT1621_segtab[6],  (LCD_RAM_Tab[23]>>4));
        Write1DataHT1621(HT1621_segtab[7],  (LCD_RAM_Tab[23]>>0));
    }
}
/************************END OF FILE****/
